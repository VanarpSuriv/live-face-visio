          ...
          <Card className="bg-card border-border">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-4 p-3 bg-secondary/20 rounded-lg">
                <strong>Note:</strong> Emails are automatically sent to
                pilotpranav2007@gmail.com after each class ends with the list of
                absent students.
              </p>
            </CardContent>
          </Card>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Absentee notifications are automatically sent after each class
                  period ends. The system uses configured SMTP credentials to
